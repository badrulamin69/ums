...
@Component({
      ...
      <div class="auth-container animate-fade-in-up">
        <div class="auth-card">
          <div class="auth-header">
            ...
            <p class="auth-subtitle">Create your Smart University account</p>
          </div>
          ...
          <form class="auth-form" (ngSubmit)="onSubmit()">
              ...
              <div class="input-wrapper">
                ...
                <button type="button" class="password-toggle" (click)="showPassword.set(!showPassword())">
                  @if (showPassword()) {
                    ...
                    <svg width="18" height="18" viewBox="0 0 18 18" fill="none"><path d="M2.25 2.25l13.5 13.5M1.5 9s3-5.25 7.5-5.25c1.13 0 2.18.3 3.12.78M16.5 9s-1.32 2.25-3.66 3.78" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"/></svg>
                  }
                </button>
              </div>
            ...
            <button type="submit"
                    class="btn btn-gold btn-full animate-fade-in-up stagger-4"
          ...
          <div class="auth-footer animate-fade-in-up stagger-5">
        ...
        <div class="auth-decoration">
          ...
          <div class="deco-text">WELCOME</div>
        </div>
      </div>
    </div>
  `,
  styles: [`
    ...
    .bg-pattern {
      ...
      inset: 0;
      background-image:
        radial-gradient(circle at 75% 25%, var(--color-gold-dim) 0%, transparent 50%),
        radial-gradient(circle at 25% 75%, rgba(200, 169, 110, 0.05) 0%, transparent 50%);
    }
...
export class RegisterComponent {
  ...
  onSubmit(): void {
    ...
    this.auth.register({ email: this.email, password: encryptedPassword }).subscribe({
      next: (res) => {
        this.loading.set(false);
        if (res.success) {
          this.toast.success('Account created! Welcome to Smart University.');
