    ...
    <div class="page animate-fade-in-up">
      <div class="page-header">
        <div>
          ...
          <p class="page-subtitle">Enroll your face and check in with face verification</p>
        </div>
  ...
  onCheckOut(base64: string) {
    this.faceService.verifyEmployeeCheckOut(base64).subscribe({
      next: (res) => {
        ...
        this.checkOutCapture?.setProcessing(false);
      },
      error: () => {
        this.checkOutCapture?.setProcessing(false);
      },
